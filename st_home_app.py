...
st.markdown(""" 
1. How does age affect injuries for a football player?
2. How does height correlate with position on a football pitch?
3. How does playing at home affect win rate and performance?
""")
# -------------------------
# SECTION: Predictor
# -------------------------
